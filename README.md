...
![PCF](https://img.shields.io/badge/Pivotal_Cloud_Foundry-00A98F?style=flat-square&logo=cloudfoundry&logoColor=white)
...
![JMS](https://img.shields.io/badge/Java_Message_Service-007396?style=flat-square&logo=java&logoColor=white)
...
<a href="https://adplist.org/mentors/vaquar-khan">
  <img src="https://img.shields.io/badge/Book_on_ADPList-FF6154?style=for-the-badge&logo=google-meet&logoColor=white&labelColor=000000" alt="Book Mentorship on ADPList" />
</a>
...
[![ADPList Profile](https://img.shields.io/badge/View_My_ADPList_Profile-→-FF6154?style=flat-square)](https://adplist.org/mentors/vaquar-khan)
...
<!-- Snake animation is generated by the GitHub Action (.github/workflows/snake.yml).
     First run: Go to Actions → "Generate Snake Animation" → "Run workflow".
     After that it regenerates daily at midnight UTC. -->
<a href="https://github.com/vaquarkhan/vaquarkhan/actions/workflows/snake.yml">
<picture>
...
> 💡 *If the snake animation is not visible, [run the GitHub Action](https://github.com/vaquarkhan/vaquarkhan/actions/workflows/snake.yml) once to generate it.*
