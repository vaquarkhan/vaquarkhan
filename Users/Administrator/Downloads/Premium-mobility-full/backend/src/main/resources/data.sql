...
TRUNCATE TABLE biometric_preferences;
TRUNCATE TABLE translator_sessions;
TRUNCATE TABLE secure_chat_messages;
TRUNCATE TABLE secure_chat_threads;
TRUNCATE TABLE feedback_entries;
TRUNCATE TABLE loyalty_transactions;
TRUNCATE TABLE experience_bookings;
TRUNCATE TABLE partner_offers;
TRUNCATE TABLE esim_orders;
TRUNCATE TABLE insurance_quotes;
TRUNCATE TABLE concierge_requests;
TRUNCATE TABLE bookings;
TRUNCATE TABLE esim_packages;
TRUNCATE TABLE insurance_products;
